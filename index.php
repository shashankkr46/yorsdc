                    ...
                    <div class="col-12">
                        <div class="hero-content-wrap flex flex-column justify-content-center align-items-start">
                            <header class="entry-header">
                                <h1>YOR SKILL DEVELOPMENT CENTER</h1>
                                <h4>A CANUM ALLENTECH INITIATIVE</h4>
                            </header><!-- .entry-header -->

                            <div class="entry-content">
                                <p>We offer learning and upskilling services with our outcome-based courses to master the cutting-edge technology and the most crucial business skills to students and professionals.</p>
                                <h4>MODES OF TRAINING : CLASSROOM GROUP LEARNING | LIVE ONLINE | SELF-PACED E-LEARNING</h4>
                            </div><!-- .entry-content -->
...
<!------------------------------------------------------------------------------------------------------------------>
<section class="feature-comp pb-5 pt-4">
 <div class="container">
     <div class="row pt-4">
        <div class="col-lg-4">
             <div class=" bg-white border-0 pb-5 pt-4">
                <div class="icon icon-box-icon-size pl-4">
                        <span class="ti-user"></span>
                </div><!-- .icon -->
                <p class="font-weight-bold icon-style pl-4">Learn from experts</p>
                 <p class="pl-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna <br>aliqua. Ut enim ad minim veniam,
                 quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                 </p>
                 <div class="course-link-design "><a href=""><small class="d-flex flex-row-reverse text-success pr-4">View More </small></a></div>
             </div>
         </div>
         <div class="col-lg-4">
             <div class=" bg-white border-0 pb-5 pt-4">
                ...
                <p class="font-weight-bold icon-style pl-4">Best course online</p>
                 <p class="pl-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna <br>aliqua. Ut enim ad minim veniam,
                 quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                 </p>
                 <div class="course-link-design "><a href=""><small class="d-flex flex-row-reverse text-success pr-4">View More </small></a></div>
         ...
         <div class="col-lg-4">
             <div class=" bg-white border-0 pb-5 pt-4">
                ...
                <p class="font-weight-bold icon-style pl-4">Best Industry Leaders</p>
                 <p class="pl-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna <br>aliqua. Ut enim ad minim veniam,
                 quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
                 </p>
                 <div class="course-link-design "><a href=""><small class="d-flex flex-row-reverse text-success pr-4">View More </small></a></div>
...
<!-------------------------------------------------------------------------------------------------------------------->
    <div class="container-fluid bg-light">
     <div class="row">
         <div class="col-lg-12 text-center mx-auto pt-4 pb-4">
             <p class="batch">Upcoming Batches</p>
             <h6 class="batch-small">Coming soon</h6>
         </div>
     </div> 
    </div>
<!--------------------------------------------------------------------------------------------------------------------->
